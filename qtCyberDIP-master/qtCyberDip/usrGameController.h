...
#define total_x 282 //318
#define total_y 531//544
...
public:
	...
	//边缘扫描
	void usrGameController::my_marginscan_td(cv::Mat img,cv:: Mat T, int n);
	void usrGameController::my_marginscan_lr(cv::Mat img, cv::Mat T, int n);
	//一圈
	void usrGameController::roundmove(int n, int x, cv::Mat pt,cv::Mat rgbd);
};
